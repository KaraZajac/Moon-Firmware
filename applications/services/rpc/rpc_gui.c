...
static void rpc_system_gui_screen_stream_frame_callback(
    ...
    if(moon_settings.rpc_color_fg.mode == ScreenColorModeRgbBacklight) {
        ...
        rpc_gui->transmit_frame->content.gui_screen_frame.fg_color =
            moon_settings.rpc_color_fg.value;
    }

    if(moon_settings.rpc_color_bg.mode == ScreenColorModeRgbBacklight) {
        ...
        rpc_gui->transmit_frame->content.gui_screen_frame.bg_color =
            moon_settings.rpc_color_bg.value;
    }
