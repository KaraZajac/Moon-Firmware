...
static void gui_redraw_status_bar(Gui* gui, bool need_attention) {
     ...
     */
    if(moon_settings.bar_background) {
...
static void gui_redraw(Gui* gui) {
    ...
    do {
        ...
        if(gui_is_lockdown(gui)) {
            ...
            if(moon_settings.lockscreen_statusbar) {
