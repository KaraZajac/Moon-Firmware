...
## Instruction
1. Go to Moon -> Misc -> Spoofing Options -> Flipper Name
...
3. You will need to exit from Moon app and Flipper will automatically reboot!
...
Currently, changing Flipper name on Moon Firmware also affects:
